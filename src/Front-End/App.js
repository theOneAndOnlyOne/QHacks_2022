...
const spotifySongLink = "https://open.spotify.com/track/6M3PsepEj5gyJoIi7Xvr7u?si=bfc44a6800f6426f";
...
function SpotifyPlugin() {
  return (
    <div className = "embed">
      <Spotify link= "https://open.spotify.com/track/6M3PsepEj5gyJoIi7Xvr7u?si=bfc44a6800f6426f"/>
    </div>
  );
}
